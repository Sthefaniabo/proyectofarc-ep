...
public class Consultar_Capacitaciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultar__capacitaciones);
...
// set current date into textview
        ...
        Cursor cur = db.rawQuery(" SELECT "+ LoginContract.LoginEntry.IDCAPA+","+ LoginContract.LoginEntry.IDREINCOR+","+ LoginContract.LoginEntry.TIPO+ " FROM "+
                LoginContract.LoginEntry.TABLE_NAME3, null);


        String [] datos=new String[cur.getCount()];
        int i=0;
        while (cur.moveToNext()){
            datos[i]=cur.getString(0) + "-" + cur.getString(1)+"-"+cur.getString(2);
    ...
    public void Volver (){
        ...
        Intent volver = new Intent(Consultar_Capacitaciones.this, Menu_Consultar.class);
